...
#SBATCH -o regenie_step2.%j.out
#SBATCH -e regenie_step2.%j.err

#SBATCH -D /well/ckb-share/gwas_breast_cancer_confluence/chr7_Dec_17
...
regenie \
  --step 2 \
  --bgen /well/ckb-share/CKB_imputed_v2.0_b38/CKB_imputed_v2_b38_chr7.bgen \
