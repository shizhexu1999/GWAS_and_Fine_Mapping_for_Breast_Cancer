...
#SBATCH -D /well/ckb/users/kws917/gwas_breast_cancer_confluence/July_8_regenie_all_chromosomes_confluence
...
regenie --step 2 \
  ...
  --bsize 400 \
  --pred /well/ckb/users/kws917/gwas_breast_cancer_confluence/July_6_regenie_confluence/regenie_step1_out_pred.list \
  --threads 8 \
  ...
  --strict \
  --af-cc \
  --out /well/ckb/users/kws917/gwas_breast_cancer_confluence/July_6_regenie_confluence/chr${CHROM}_out
