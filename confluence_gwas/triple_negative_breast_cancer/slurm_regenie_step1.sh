...
regenie --step 1 \
  ...
  --strict \
  --bsize 1000 --bt \
  --lowmem --lowmem-prefix /well/ckb/users/kws917/gwas_breast_cancer_confluence/July_10_regenie_all_chromosomes_triple_negative/tmp_rg \
  --gz --threads 8 \
  --use-relative-path \
  --out /well/ckb/users/kws917/gwas_breast_cancer_confluence/July_10_regenie_all_chromosomes_triple_negative/regenie_step1_out \
  --loocv
