...
#SBATCH -D /well/ckb/users/kws917/gwas_breast_cancer_confluence/July_10_regenie_all_chromosomes_er_positive
...
regenie --step 2 \
  ...
  --phenoFile /well/ckb/users/kws917/gwas_breast_cancer_confluence/July_6_regenie_confluence/final_phenotype_file_ER_positive.txt \
  --phenoColList ER_positive_subtype \
  --bsize 400 \
  --pred /well/ckb/users/kws917/gwas_breast_cancer_confluence/July_10_regenie_all_chromosomes_er_positive/regenie_step1_out_pred.list \
  --threads 8 \
  ...
  --strict \
  --af-cc \
  --out /well/ckb/users/kws917/gwas_breast_cancer_confluence/July_10_regenie_all_chromosomes_er_positive/chr${CHROM}_out
